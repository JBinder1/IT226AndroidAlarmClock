    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonNewAlarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(view.getContext(), AlarmSetupActivity.class);
                startActivity(i);
            }
        });
        buttonNewTimer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(view.getContext(), TimerSetupActivity.class);
                startActivity(i);
            }
        });
        buttonConfigureLocationAlarm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(view.getContext(), LocationAlarmSettings.class);
                startActivity(i);
            }
        });
