...
final class GoogleCalendarManager {
    ...
    public GoogleCalendarManager(MainActivity mainActivity) {
        this.mainActivity = mainActivity;

        mCredential = GoogleAccountCredential.usingOAuth2(
                mainActivity.getApplicationContext(), Arrays.asList(SCOPES))
    ...
    void addEvent(final String message, final Calendar calendar) {
